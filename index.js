...
const runServer = async () => {
   ...
   // --- SWAGGER AUTO DOCS ---
   const openApiSpec = await generateOpenAPISpec(path.join(process.cwd(), 'routers'))
   app.get('/openapi.json', (req, res) => {
      res.json(openApiSpec)
   })
   app.use('/docs', swaggerUi.serve, swaggerUi.setup(openApiSpec))
   // --- END SWAGGER AUTO DOCS ---
   ...
   app.listen(PORT, () => {
      ...
      console.log(chalk.greenBright.bold('Swagger Docs ---> http://localhost:' + PORT + '/docs'))
   })
}
